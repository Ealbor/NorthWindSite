...
namespace Northwind.Controllers
{
    public class APIController : Controller
    {
        ...
        //This will be used temporarily to make sure that things are working
        ...
        [HttpGet, Route("reports/Country/Customers")]
        //returns customers of distinct Countries
        public Customer GetCustomer() => repository.Customers.FirstOrDefault(c => c.CustomerID == 1);
